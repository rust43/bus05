    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('map_object', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='line', to='map.mapobject')),
            ],
        ),
        migrations.CreateModel(
            name='ObjectPoint',
            fields=[
                ...
                ('map_object', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='point', to='map.mapobject')),
            ],
        ),
        migrations.CreateModel(
            name='ObjectPolygon',
